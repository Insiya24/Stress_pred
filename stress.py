...
model_filename = 'human_stress_model.pkl'  # Replace with the actual filename
...
#st.write("Enter the following inputs to predict stress level:")
st.markdown("""
<style>
.big-font {
...
if st.button("Predict Stress Level"):
    ...
    #st.write(f"Predicted Stress Level: {predicted_sl}")
    if(predicted_sl==0):
        ...
        st.text("Experiencing profound tension significantly impairs cognitive function & emptional well-being , severe health ramification emphasizing the urgentb need for help to reduce health effects ")
